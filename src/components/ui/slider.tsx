...
const Slider = React.forwardRef<
  ...
  EnhancedSliderProps
>(({ className, variant = 'default', thickness = 'default', showMarks = false, marks, ...props }, ref) => {
        ...
        {props.value?.map((_, i) => (
          <SliderPrimitive.Thumb 
            ...
            className={cn(
              ...
              "disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/10",
              getThumbSizeClasses()
            )} 
          />
        ))}
